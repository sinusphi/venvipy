...
class BasicSettings(QWizardPage):
    ...
    def __init__(self):
        ...
        self.m_install_worker.step_pip.connect(self.show_pipup_msg)
    ...
    def show_pipup_msg(self):
        """
        In progress bar show that Pip is being updated.
        """
